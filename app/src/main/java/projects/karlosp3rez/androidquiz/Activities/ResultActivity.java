...
import projects.karlosp3rez.androidquiz.Adapter.ResultGridAdapter;
import projects.karlosp3rez.androidquiz.Common.Common;
import projects.karlosp3rez.androidquiz.Common.SpaceDecoration;
import projects.karlosp3rez.androidquiz.MainActivity;
...
public class ResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (percent > 90)
            txt_result.setText(getString(R.string.hint_result_excellent));
        else if (percent > 80)
            txt_result.setText(getString(R.string.hint_result_good));
        else if (percent > 50)
            txt_result.setText(getString(R.string.hint_result_poor));
        else if (percent > 40)
            txt_result.setText(getString(R.string.hint_result_bad));
        else
            txt_result.setText(getString(R.string.hint_result_failing));
    ...
    private void doQuizAgain() {
        new MaterialStyledDialog.Builder(ResultActivity.this)
                .setTitle(getString(R.string.do_again_prompt))
                .setIcon(R.drawable.ic_mood_black_24dp)
                .setDescription(getString(R.string.delete_data_confirm))
    ...
    private void initUI() {
        ...
        toolbar.setTitle(getString(R.string.hint_result));
